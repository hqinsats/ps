      ...
      TMouseButton Button, TShiftState Shift, int X, int Y)
{
        ...
        Image2->Picture->LoadFromFile("k2_2.jpg"); //анимация при нажатии на кнопку
}
//---------------------------------------------------------------------------
      ...
      TShiftState Shift, int X, int Y)
{
        ...
        Image2->Picture->LoadFromFile("k1_2.jpg");  //статичная анимация
}
//---------------------------------------------------------------------------
void __fastcall TForm2::Image2Click(TObject *Sender)
{
        Form3->ShowModal(); //запуск третьей формы при нажатии на image
}
//---------------------------------------------------------------------------

void __fastcall TForm2::Label1Click(TObject *Sender)
{
       Form3->ShowModal();//запуск третьей формы при нажатии на текст
}
//---------------------------------------------------------------------------
